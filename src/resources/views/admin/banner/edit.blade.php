                                ...
                                <select class="form-select" name="service" id="service">
                                    ...
                                    @foreach ($product as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->id == $banner->product_id ? 'selected' : '' }}>
                            ...
                            @if ($section == 1)
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="subtitle"
                                        placeholder="{{ trans('labels.subtitle') }}" value="{{$banner->sub_title}}" required>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="link_text"
                                        placeholder="{{ trans('labels.link_text') }}" value="{{$banner->link_text}}" required>
